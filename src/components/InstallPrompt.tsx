...
export const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 md:max-w-sm bg-blue-600 text-white rounded-lg shadow-xl p-4 z-40 backdrop-blur-sm bg-opacity-95 border border-blue-500">
      <div className="flex items-start space-x-3">
        <div className="flex-shrink-0">
          <img 
            src="/markdown-renderer/icon-192.png" 
            alt="Markdown Viewer App Icon"
            className="w-12 h-12 rounded-lg shadow-sm app-icon-pulse"
          />
        </div>
      ...
      <div className="flex space-x-3 mt-3">
        <button
          ...
          className="btn-install-primary flex items-center justify-center gap-2"
        >
